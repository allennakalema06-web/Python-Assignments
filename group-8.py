...
# Design and implement a python code that can be used to determine the grade input by a student, make sure you capture the student's name, age, school and the subject for the grade.
# Conditions; 0 - 60 (pass), 60 - 75 (Good), 75 - 85 (Excellent),Above 85 (Exception).
